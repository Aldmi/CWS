...
namespace Shared.Helpers
{
    public static class HelperStringFormatInseart
    {
        ...
        {
            return ConvertString2IndependentInseartCollection(str, pattern)
                .DistinctBy(insert => insert.Replacement)
                .ToDictionary(insert => insert.VarName, insert => insert);
        }


        private static IEnumerable<StringInsertModel> ConvertString2IndependentInseartCollection(string str, string pattern)
        {
