...
{
    public class AdInputType4XmlDtoMappingTest
    {
        [Fact]
        public void MappingFromDtoToObj()
        {
            ...
            var xmlDto = new AdInputType4XmlDto()
            {
                ...
                Route = "Станция1-Станция2-Станция3"
            ...
            // //Asert
             res.Route.NameRu.Should().Be("Станция1-Станция2-Станция3");
             res.Route.NameEng.Should().BeNull();
