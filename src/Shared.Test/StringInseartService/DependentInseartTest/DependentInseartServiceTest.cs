    ...
    public class DependentInseartServiceTest
    {
        ...
        public static IEnumerable<object[]> ExecuteInseartsDatas => new[]
        {
            ...
            new object[]
            {
                ...
                "0x030x{CRCXor:X2_Border}0x1F",
                "Windows-1251",
                new StringBuilder("0xFF0xFF0x020x1B0x57Дополн. Хабаровск0x0918:000x09Со всеми остановками0x090x030x{CRCXor:X2_Border}0x1F"),
        ...
        public void ServiceFactory_Exception_crcModel_NotFound_For_Nchar_Handler_Test()
        {
            ...
            var body= "%30{SyncTInSec:X5}%010C60EF03B0470000001E%110406NNNNN%01000023{MATH(rowNumber*24-23){NumberOfCharacters01\\\"78\\\"";
